...
| 연도 | 수상 |
|:----:|------|
| **2025** | **최우수상 (1위)** — KU 산학연계 캡스톤 디자인 경진대회<br><sub>DocScanner: Agentic RAG 기반 근로계약서 분석 AI</sub> |
| **2025** | **최우수상 (정보통신기획평가원장상)** — 제10회 SW인재페스티벌<br><sub>Smart Food Research Agent System: Multi-Agent RAG 시스템</sub> |
| **2025** | **은상** — 고려대학교 Uni-con 창업경진대회<br><sub>e:room: AI 룸메이트 매칭 및 사기 탐지 플랫폼</sub> |
...
[![PDF](https://img.shields.io/badge/PDF-논문_보기-B31B1B?style=flat-square&logo=adobeacrobatreader&logoColor=white)](https://github.com/danlee-dev/danlee-dev/blob/main/paper/Enhancing-Multi-Hop-Complex-Query-Retrieval-Efficiency-through-the-Integration-of-RAG-and-Graph-RAG.pdf)
...
[![Repository](https://img.shields.io/badge/Repository-252RCOSE48001-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/danlee-dev/252RCOSE48001)
![Award](https://img.shields.io/badge/Award-최우수상-FFD700?style=flat-square)
...
[![Repository](https://img.shields.io/badge/Repository-ip--to--portrait-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/Diffusion-planet/ip-to-portrait)
...
[![Repository](https://img.shields.io/badge/Repository-git--deck-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/danlee-dev/git-deck)
...
[![Repository](https://img.shields.io/badge/Repository-cardealo-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/danlee-dev/cardealo)
...
[![Repository](https://img.shields.io/badge/Repository-crowdworks--multiagent--system-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/danlee-dev/crowdworks-multiagent-system)
![Award](https://img.shields.io/badge/Award-최우수상-FFD700?style=flat-square)
...
<img src="https://skillicons.dev/icons?i=python,pytorch,typescript,react,nextjs,fastapi&theme=light" alt="Languages and Frameworks" />

<br><br>

**Database & Infrastructure**

<img src="https://skillicons.dev/icons?i=postgres,elasticsearch,redis,docker&theme=light" alt="Database and Infrastructure" />
...
|:----------:|:-----------:|
| [![AI Project Hub](https://img.shields.io/badge/AI_Project_Hub-24292e?style=for-the-badge&logo=github&logoColor=white)](https://github.com/danlee-dev/ai-project-hub) | AI 애플리케이션 & 서비스 |
| [![AI Paper Impl](https://img.shields.io/badge/AI_Paper_Impl-24292e?style=for-the-badge&logo=python&logoColor=white)](https://github.com/danlee-dev/ai-paper-implementations) | Multimodal 모델 구현 |
| [![CS Core Labs](https://img.shields.io/badge/CS_Core_Labs-24292e?style=for-the-badge&logo=cplusplus&logoColor=white)](https://github.com/danlee-dev/cs-core-labs) | OS, 논리설계, 컴퓨터구조 |
